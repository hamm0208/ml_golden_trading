...
const Hero = () => {
  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      <div className={`absolute inset-0 lg:top-[80px] sm:top-[150px] top-[50px] mx-auto flex lg:flex-row flex-col items-start gap-10`}>
        <div className='lg:w-5/6 w-full flex flex-col justify-center items-center lg:bg-transparent home p-6 mt-32 rounded-xl landing'>
          <h1 className='text-white text-[20px] xl:text-5xl text-center'>
            Transform Your Ground Leveling with our <br/>
            <span className='text-secondary text-[25px] xl:text-5xl'>
              Flat Floor System
            </span>
          </h1>
          <p className='text-center lg:mt-18 mt-12 mb-6 xl:text-2xl text-white'>
