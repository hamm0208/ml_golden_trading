...
const Benefits = () => {
  ...
  return (
    <section>
      <div className='relative w-full h-full lg:mb-40 3xl:mb-20 xl:mb-40 mb-14 z-0 benefits mt-5'>
        <div className='px-14 '>
          <div className='2xl:text-left  2xl:w-full flex flex-col 2xl:justify-start 2xl:items-start justify-center items-center'>
            ...
            <h3 className='text-xl lilita text-primary'>How can we help you?</h3>
          </div>
                ...
                <React.Fragment key={index}>
                  ...
                  <div className='col-span-4 w-full h-full'>
                    <div className='w-full h-full bg-secondary rounded-md p-4 md:pl-4'>
                      <h3 className='text-xl font-medium py-2'>{benefit.benefits}</h3>
                  ...
                  <div className='col-span-1 w-full h-full flex justify-center items-center relative'>
                    <div className='h-full w-1 bg-secondary'></div>
                    <img src={benefit.icon} alt={benefit.benefits} className='absolute bg-primary p-3 rounded-full'/>
                  </div>
                  <div className='col-span-4 w-full h-full'>
                    <div className='w-full h-full bg-secondary rounded-md p-4 md:pl-4'>
                      <h3 className='text-xl font-medium py-2'>{benefit.benefits}</h3>
