          ...
          <h3 className='text-2xl font-bold'>Flat Floor System Process</h3>
            <div className='flex flex-col rounded-2xl 2xl:w-3/4 justify-items-center p-3 mt-3 bg-primary'>
              <div className='flex sm:flex-row flex-col'>
                ...
                <div className='sm:m-2 mt-5 sm:mx-3 md:text-lg sm:text-sm text-md p-2 w-full h-40 lg:h-52 lg:w-42 flex-1 rounded-2xl bg-[#DADBDD] text-center flex justify-center items-center'>
                  {procedure[1].processNo + ". " + procedure[1].instruction}
                </div>
                <div className='sm:m-2 mt-5 sm:mx-3 md:text-lg sm:text-sm text-md p-2 w-full h-40 lg:h-52 lg:w-42 flex-1 rounded-2xl bg-white text-center flex justify-center items-center'>
