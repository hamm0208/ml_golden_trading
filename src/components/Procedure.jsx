...
const Procedure = () => {
  return (
    <section className='relative w-full h-full lg:mb-44 mb-20 procedure'>
      <div className={`p-5 flex 3xl:flex-row flex-col relative inset-0 lg:top-[200px] xl:top-[200px] 2xl:top-[200px] 3xl:top-[100px] top-[100px] mx-auto  items-center`}>
          ...
          <h3 className='text-2xl font-bold'>Flat Floor System Process</h3>
            <div className='flex flex-col rounded-2xl 3xl:w-3/4 justify-items-center p-3 mt-3 bg-primary'>
              <div className='flex flex-row'>
                <div className='md:text-xl text-l m-3 h-[150px] p-2  flex-1 rounded-2xl bg-secondary text-center flex justify-center items-center'>
                  {procedure[0].processNo + ". " + procedure[0].instruction}
                </div>
                <div className='md:text-xl text-l m-3 h-[150px] p-2  flex-1 rounded-2xl bg-[#DADBDD] text-center flex justify-center items-center'>
                  {procedure[1].processNo + ". " + procedure[1].instruction}
                </div>
                <div className='md:text-xl text-l m-3 h-[150px] p-2 flex-1 rounded-2xl bg-white text-center flex justify-center items-center'>
        ...
        <div className='bg-primary rounded-xl p-8 my-5'>
          <h2 className='text-white text-2xl text-center mb-3 '>Example:</h2>
            <video src={demo_vid} autoPlay loop className=''>
